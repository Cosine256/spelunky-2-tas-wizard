        ...
        if session then
            ...
            if frames_edit_level == 0 and session.current_level_index == -1 then
                ...
                if frames_edit_operation == "insert" then
                    ...
                    for player_index = 1, session.tas.player_count do
                        ...
                        if session.tas.player_count == 1 then
    ...
    ctx:win_section("Input viewer", function()
        ...
        elseif game_controller.current_frame_index == -1 then
            ...
            if session.tas.player_count == 1 then
                ...
                for i = 1, session.tas.player_count do
                    player_choices[i] = i.." ("..common_enums.PLAYER_CHAR:value_by_id(session.tas.players[i]).name..")"
                end
