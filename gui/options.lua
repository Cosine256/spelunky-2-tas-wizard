...
function module:draw_panel(ctx, is_window)
    ...
    ctx:win_text("Instead of automatically engine pausing in a transition screen, temporarily suppress TAS inputs and wait for the user to exit the transition manually.")
