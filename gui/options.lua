...
function module:draw_panel(ctx, is_window)
    ...
    ctx:win_section("Debug Prints", function()
        ctx:win_indent(common_gui.INDENT_SECTION)
        options.debug_print_fast_update = ctx:win_check("Fast update", options.debug_print_fast_update)
        options.debug_print_file = ctx:win_check("File", options.debug_print_file)
        options.debug_print_input = ctx:win_check("Input", options.debug_print_input)
        options.debug_print_misc = ctx:win_check("Miscellaneous", options.debug_print_misc)
        options.debug_print_mode = ctx:win_check("Mode", options.debug_print_mode)
        options.debug_print_pause = ctx:win_check("Pause", options.debug_print_pause)
        options.debug_print_screen_load = ctx:win_check("Screen load", options.debug_print_screen_load)
        options.debug_print_snapshot = ctx:win_check("Snapshot", options.debug_print_snapshot)
        ctx:win_indent(-common_gui.INDENT_SECTION)
    end)
    ctx:win_popid()
