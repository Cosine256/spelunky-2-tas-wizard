...
function module:draw_panel(ctx, is_window)
    ...
    ctx:win_text("These options control game engine pauses. This is the same system used by Overlunky for pausing and frame advancing. Game engine pauses will not occur unless Overlunky is attached to the current game session.")
